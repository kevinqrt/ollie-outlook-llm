 ...
 */
export const getPipelineModels = <ThrowOnError extends boolean = false>(options?: Options<GetPipelineModelsData, ThrowOnError>) => (options?.client ?? client).get<GetPipelineModelsResponses, unknown, ThrowOnError>({ url: '/pipeline/models', ...options });
